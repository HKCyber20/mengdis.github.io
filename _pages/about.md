--- # YAML front matter 定义页面元数据
permalink: / # 页面 URL（此处为站点首页）
title: "Hi，I'm Mengdi Shi." # 页面的标题
author_profile: true # 是否显示侧边栏作者信息
redirect_from:  # 旧链接自动重定向到此页
  - /about/
  - /about.html
---

<!-- # 以下是正文内容，使用 Markdown 撰写 -->
